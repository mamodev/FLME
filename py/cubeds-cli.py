...
#python cubeds-cli.py --name lswap-skew --nsamples 2000 --ngroups 8 --space-size=10 --no-fskew --lswap 0,0,2 --lswap 1,0,1 --lswap 2,0,3 --lswap 3,0,3 --lswap 4,0,7 --lswap 5,0,0 --lswap 6,0,0 --lswap 7,0,3 --lswap 0,1,2 --lswap 1,1,7 --lswap 2,1,0 --lswap 3,1,0 --lswap 4,1,3 --lswap 5,1,2 --lswap 6,1,4 --lswap 7,1,5 --lswap 0,2,7 --lswap 1,2,1 --lswap 2,2,1 --lswap 3,2,4 --lswap 4,2,6 --lswap 5,2,3 --lswap 6,2,3 --lswap 7,2,4 --lswap 0,3,1 --lswap 1,3,3 --lswap 2,3,2 --lswap 3,3,2 --lswap 4,3,0 --lswap 5,3,4 --lswap 6,3,0 --lswap 7,3,1 --lswap 0,4,5 --lswap 1,4,5 --lswap 2,4,2 --lswap 3,4,7 --lswap 4,4,6 --lswap 5,4,2 --lswap 6,4,3 --lswap 7,4,5 --lswap 0,5,6 --lswap 1,5,4 --lswap 2,5,4 --lswap 3,5,0 --lswap 4,5,5 --lswap 5,5,7 --lswap 6,5,6 --lswap 7,5,4 --lswap 0,6,6 --lswap 1,6,0 --lswap 2,6,2 --lswap 3,6,0 --lswap 4,6,6 --lswap 5,6,3 --lswap 6,6,7 --lswap 7,6,4 --lswap 0,7,4 --lswap 1,7,2 --lswap 2,7,6 --lswap 3,7,3 --lswap 4,7,6 --lswap 5,7,5 --lswap 6,7,6 --lswap 7,7,3


# python cubeds-cli.py --nsamples 20000 --ngroups 1 --space-size=10 --name cuboids

    # python cubeds-cli.py --name lswap-skew --nsamples 2000 --ngroups 8 --space-size=10 --no-fskew --lswap 0,0,1 --lswap 1,1,2 --lswap 2,2,3 --lswap 3,3,4 --lswap 4,4,5 --lswap 5,5,6 --lswap 6,6,7 --lswap 7,7,0
...
def random_shuffle(ngroups, nlabels=8):
    swaps = []

    for i in range(nlabels):
        for g in range(ngroups):
            swaps.append((g, i, np.random.randint(0, nlabels)))


    swaps = [f"--lswap {g},{l1},{l2}" for g, l1, l2 in swaps]
    print(" ".join(swaps))
    ...
    if gui:
        for gidx, xx in enumerate(novoid(groups_points)):
            for ss_idx, x in enumerate(xx):
                ...
                ax.scatter(x[:, 0], x[:, 1], x[:, 2], s=40, alpha=0.5, marker=MRK_PLT[gidx], c=CLR_PLT[lidx])
